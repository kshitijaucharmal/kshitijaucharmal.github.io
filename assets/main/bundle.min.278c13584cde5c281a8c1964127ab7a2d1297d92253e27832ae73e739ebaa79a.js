(() => {
  ...
  // ns-hugo:/home/kshitij/.cache/hugo_cache/modules/filecache/modules/pkg/mod/github.com/razonyang/hugo-theme-bootstrap@v1.5.5/assets/js/snackbar/index.ts
  var Snackbar = class {
    constructor() {
  ...
  // ns-hugo:/home/kshitij/.cache/hugo_cache/modules/filecache/modules/pkg/mod/github.com/razonyang/hugo-theme-bootstrap@v1.5.5/assets/js/actions-panel/index.ts
  ...
  // ns-hugo:/home/kshitij/.cache/hugo_cache/modules/filecache/modules/pkg/mod/github.com/razonyang/hugo-theme-bootstrap@v1.5.5/assets/js/app/index.ts
  var App = class {
    constructor() {
  ...
  var params_default = { analytics: null, archive: { paginate: 20 }, baseURL: "http://localhost:1313/", breadcrumb: true, carouselpostcount: 5, codeblock: { linenos: false }, color: "auto", contact: { endpoint: "https://getform.io/f/56041c81-9e03-4c24-b9c5-61238854d4cd" }, counttaxonomyposts: true, creativecommons: { by: true }, customcss: null, customjs: null, dateformat: "2 January 2006", description: "An extreme fast, responsive and feature-rich blog theme for Hugo", diagram: false, displayname: "EN", featuredpostcount: 5, fixedheader: true, fontsize: null, fullwidth: false, giscus, googleadsense: null, isocode: "en", keywords: "Hugo, Bootstrap, Blog, Personal", mainsections: ["blog", "posts"], palette: "orange", palettes: ["blue", "blue gray", "brown", "cyan", "green", "indigo", "orange", "pink", "purple", "red", "teal", "yellow"], pinnedpost: true, pinnedpostcount: 3, post: { featuredimage: true, numberifyheadings: true, numberifyheadingsseparator: "." }, postdate: true, poweredby: true, pwa: { manifest: { short_name: "HBS" } }, readingtime: true, recentpostcount: 5, relatedpostcount: 5, repo: { branch: "main", url: "https://github.com/kshitijaucharmal/hugo-website-main" }, rtl: false, search: { fuse: { threshold: 0.1 }, paginate: 5 }, searchbar: true, sidebar: null, sidebartaxonomies: ["series", "categories", "tags", "authors"], siteverification: { google: null }, social: { email: "kshitijaucharmal21@gmail.com", github: "kshitijaucharmal", gitlab: "kshitijaucharmal", instagram: "k5h1t1j_4uch4rm4l", linkedin: "kshitijaucharmal21", reddit: "_k5h1t1j_" }, taxonomypaginate: 10, taxonomypostcount: 20, titlecase: true, titleseparator: "-", tocwordcount: 1, topappbar: { social: { email: "kshitijaucharmal21@gmail.com", github: "kshitijaucharmal", linkedin: "kshitijaucharmal21" } }, viewer: true };

  // ns-hugo:/home/kshitij/.cache/hugo_cache/modules/filecache/modules/pkg/mod/github.com/razonyang/hugo-theme-bootstrap@v1.5.5/assets/js/code/code-block.ts
  var CodeBlock = class {
    constructor(element) {
  ...
  // ns-hugo:/home/kshitij/.cache/hugo_cache/modules/filecache/modules/pkg/mod/github.com/razonyang/hugo-theme-bootstrap@v1.5.5/assets/js/code/index.ts
  var Code = class {
    run() {
  ...
  // ns-hugo:/home/kshitij/.cache/hugo_cache/modules/filecache/modules/pkg/mod/github.com/razonyang/hugo-theme-bootstrap@v1.5.5/assets/js/docs/catalog.ts
  var Catalog = class {
    run() {
  ...
  // ns-hugo:/home/kshitij/.cache/hugo_cache/modules/filecache/modules/pkg/mod/github.com/razonyang/hugo-theme-bootstrap@v1.5.5/assets/js/docs/index.ts
  var Docs = class {
    run() {
  ...
  // ns-hugo:/home/kshitij/.cache/hugo_cache/modules/filecache/modules/pkg/mod/github.com/razonyang/hugo-theme-bootstrap@v1.5.5/assets/js/local-storage/index.ts
  ...
  // ns-hugo:/home/kshitij/.cache/hugo_cache/modules/filecache/modules/pkg/mod/github.com/razonyang/hugo-theme-bootstrap@v1.5.5/assets/js/font-size-selector/index.ts
  ...
  // ns-hugo:/home/kshitij/.cache/hugo_cache/modules/filecache/modules/pkg/mod/github.com/razonyang/hugo-theme-bootstrap@v1.5.5/assets/js/form-validator/index.ts
  ...
  // ns-hugo:/home/kshitij/.cache/hugo_cache/modules/filecache/modules/pkg/mod/github.com/razonyang/hugo-theme-bootstrap@v1.5.5/assets/js/iframe/index.ts
  var IFrame = class {
    run() {
      this.load();
      this.fullscreen();
  ...
  // ns-hugo:/home/kshitij/.cache/hugo_cache/modules/filecache/modules/pkg/mod/github.com/razonyang/hugo-theme-bootstrap@v1.5.5/assets/js/loading-bar/index.ts
  ...
  // ns-hugo:/home/kshitij/.cache/hugo_cache/modules/filecache/modules/pkg/mod/github.com/razonyang/hugo-theme-bootstrap@v1.5.5/assets/js/scroller/index.ts
  var Scroller = class {
    constructor() {
      __publicField(this, "btn");
  ...
  // ns-hugo:/home/kshitij/.cache/hugo_cache/modules/filecache/modules/pkg/mod/github.com/razonyang/hugo-theme-bootstrap@v1.5.5/assets/js/sidebar-toggle/index.ts
  ...
  // ns-hugo:/home/kshitij/.cache/hugo_cache/modules/filecache/modules/pkg/mod/github.com/razonyang/hugo-theme-bootstrap@v1.5.5/assets/js/table-wrapper/index.ts
  ...
  // ns-hugo:/home/kshitij/.cache/hugo_cache/modules/filecache/modules/pkg/mod/github.com/razonyang/hugo-theme-bootstrap@v1.5.5/assets/js/toc/index.ts
  var TOC = class {
  ...
  // ns-hugo:/home/kshitij/.cache/hugo_cache/modules/filecache/modules/pkg/mod/github.com/razonyang/hugo-theme-bootstrap@v1.5.5/assets/main/js/components.ts
  var components = [];
  var components_default = components;

  // ns-hugo:/home/kshitij/.cache/hugo_cache/modules/filecache/modules/pkg/mod/github.com/razonyang/hugo-theme-bootstrap@v1.5.5/assets/js/slide/index.ts
  (() => {
    "use strict";
  ...
  // ns-hugo:/home/kshitij/.cache/hugo_cache/modules/filecache/modules/pkg/mod/github.com/razonyang/hugo-theme-bootstrap@v1.5.5/assets/js/search/index.ts
  (() => {
    "use strict";
    var _a, _b;
  ...
  // ns-hugo:/home/kshitij/.cache/hugo_cache/modules/filecache/modules/pkg/mod/github.com/razonyang/hugo-theme-bootstrap@v1.5.5/assets/js/mode/index.ts
  var MODE_AUTO = "auto";
  var MODE_DARK = "dark";
