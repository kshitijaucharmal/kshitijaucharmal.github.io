(() => {
  ...
  var params_default = { analytics: null, archive: { paginate: 20 }, baseURL: "http://localhost:1313/", breadcrumb: true, carouselpostcount: 5, codeblock: { linenos: false }, color: "auto", contact: { endpoint: "https://getform.io/f/56041c81-9e03-4c24-b9c5-61238854d4cd" }, counttaxonomyposts: true, creativecommons: { by: true }, customcss: null, customjs: null, dateformat: ":date_long", description: "An extreme fast, responsive and feature-rich blog theme for Hugo", diagram: false, featuredpostcount: 5, fixedheader: true, fontsize: null, fullwidth: false, giscus, googleadsense: null, keywords: "Hugo, Bootstrap, Blog, Personal", mainsections: ["blog", "posts"], palette: "orange", palettes: ["blue", "blue gray", "brown", "cyan", "green", "indigo", "orange", "pink", "purple", "red", "teal", "yellow"], pinnedpost: true, pinnedpostcount: 3, post: { featuredimage: true, numberifyheadings: true, numberifyheadingsseparator: "." }, postdate: true, poweredby: true, pwa: { manifest: { short_name: "HBS" } }, readingtime: true, recentpostcount: 5, relatedpostcount: 5, repo: { branch: "main", url: "https://github.com/kshitijaucharmal/hugo-website-main" }, search: { fuse: { threshold: 0.1 }, paginate: 5 }, searchbar: true, sidebar: null, sidebartaxonomies: ["series", "categories", "tags", "authors"], siteverification: { google: null }, social: { email: "kshitijaucharmal21@gmail.com", github: "kshitijaucharmal", gitlab: "kshitijaucharmal", instagram: "k5h1t1j_4uch4rm4l", linkedin: "kshitijaucharmal21", reddit: "_k5h1t1j_" }, taxonomypaginate: 10, taxonomypostcount: 20, titlecase: true, titleseparator: "-", tocwordcount: 1, topappbar: { social: { email: "kshitijaucharmal21@gmail.com", github: "kshitijaucharmal", linkedin: "kshitijaucharmal21" } }, viewer: true };
